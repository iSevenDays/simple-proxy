...
func TestToolCorrectionFlow(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			disabledService := correction.NewService(NewMockConfigProvider("http://test"), "test-key", false, "test-model", false, nil)
...
func TestSlashCommandToTaskConversion(t *testing.T) {
	service := correction.NewService(NewMockConfigProvider("http://test.com"), "test-key", true, "test-model", true, nil)
